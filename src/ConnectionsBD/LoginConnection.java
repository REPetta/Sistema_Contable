...
public class LoginConnection {
    ...
    //Metodo para validar si el usuario y contraseña ingresado esta en registrado en la base de datos//
   public boolean validateUser(String userName, String password) throws ClassNotFoundException, SQLException, IOException{
       ...
       String sql="SELECT*FROM Usuario WHERE userName=? AND password=?";//Consulta sql a la base de datos//
        try{
            //Atributos//
            ...
            ps.setString(2, password);//Asgina al segundo ? el password//
