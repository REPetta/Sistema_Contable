 ...
 * @author elias
 */
public class AddAccountSeatView extends javax.swing.JFrame {

    /**
     * Creates new form AccountSeat
     */
    public AddAccountSeatView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAccountSeatView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddAccountSeatView().setVisible(true);
            }
        });
    }
