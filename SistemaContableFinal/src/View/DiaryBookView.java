 ...
 * @author Rodrigo
 */
public class DiaryBookView extends javax.swing.JFrame {

    /**
     * Creates new form LibroDiario
     */
    public DiaryBookView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiaryBookView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiaryBookView().setVisible(true);
            }
        });
    }
