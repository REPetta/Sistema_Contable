 ...
 * @author elias
 */
public class ShowChartAccountsView extends javax.swing.JFrame {

    /**
     * Creates new form ShowChartAccounts
     */
    public ShowChartAccountsView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowChartAccountsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowChartAccountsView().setVisible(true);
            }
        });
    }
