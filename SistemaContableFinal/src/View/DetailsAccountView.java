 ...
 * @author Rodrigo
 */
public class DetailsAccountView extends javax.swing.JFrame {

    /**
     * Creates new form DetailsAccount
     */
    public DetailsAccountView() {
        initComponents();
...
//        add(txtType);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailsAccountView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailsAccountView().setVisible(true);
            }
        });
    }
